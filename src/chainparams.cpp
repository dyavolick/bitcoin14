...
public:
    CMainParams() {
        ...
        consensus.nRuleChangeActivationThreshold = 0.75 * consensus.nMinerConfirmationWindow; // 95% of 2016
        ...
        vSeeds.push_back(CDNSSeedData("18.219.153.195", "18.219.153.195", true)); // Pieter Wuille, only supports x1, x5, x9, and xd
        vSeeds.push_back(CDNSSeedData("18.219.126.223", "18.219.126.223", true)); // Matt Corallo, only supports x9
        ...
        checkpointData = (CCheckpointData) {
            ...
            ( 0, uint256S("0x000000006a4cbdc03dbf67c5e5868aae1ec3fdea491482213cb3a9619e716395")) 
        };
...
public:
 ...
 genesis = CreateGenesisBlock(1524088375, 2825755318, 0x1d00ffff, 1, 50 * COIN);
     ...
     assert(consensus.hashGenesisBlock == uint256S("0x000000006a4cbdc03dbf67c5e5868aae1ec3fdea491482213cb3a9619e716395"));
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            ( 546, uint256S("000000006a4cbdc03dbf67c5e5868aae1ec3fdea491482213cb3a9619e716395")),
        };
...
public:
    CRegTestParams() {
        ...
        genesis = CreateGenesisBlock(1518220801, 0, 0x207fffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x3e2841bfb23acc0f9f7766d542629a0d2fba00fa696097a1dd1760d21feccfb8"));
        ...
        checkpointData = (CCheckpointData){
            boost::assign::map_list_of
            ( 0, uint256S("3e2841bfb23acc0f9f7766d542629a0d2fba00fa696097a1dd1760d21feccfb8"))
        };
