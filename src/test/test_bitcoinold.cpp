...
#define BOOST_TEST_MODULE Bitcoinold Test Suite

#include "test_bitcoinold.h"
...
TestingSetup::TestingSetup(const std::string& chainName) : BasicTestingSetup(chainName)
{
    const CChainParams& chainparams = Params();
        ...
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_bitcoinold_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
