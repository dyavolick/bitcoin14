...
#ifndef BITCOINOLD_TEST_SCRIPTNUM10_H
#define BITCOINOLD_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Bitcoinold Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // BITCOINOLD_TEST_BIGNUM_H
