...
# Copyright 2016 The Bitcoinold Core developers
...
help_text="""Test framework for bitcoinold utils.

Runs automatically during `make check`.

Can also be run manually from the src directory by specifying the source directory:

test/bitcoinold-util-test.py --srcdir='srcdir' [--verbose]
"""
...
if __name__ == '__main__':
    ...
    bctest.bctester(srcdir + "/test/data", "bitcoinold-util-test.json", buildenv)
