...
#if defined(NDEBUG)
# error "Bitcoinold cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Bitcoinold Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<uint256>& vHashTxnToUncache)
{
...

    {
        ...
        {
            LogPrint("mempool", "replacing tx %s with %s for %s BOL additional fees, %d delta bytes\n",
