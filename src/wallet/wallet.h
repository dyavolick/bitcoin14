...
#ifndef BITCOINOLD_WALLET_WALLET_H
#define BITCOINOLD_WALLET_WALLET_H
...
public:
     ...
     * on this bitcoinold node, and set to 0 for transactions that were created
...
#endif // BITCOINOLD_WALLET_WALLET_H
