Bitcoinold version 0.5.4 is now available for download at:
http://sourceforge.net/projects/bitcoinold/files/Bitcoinold/bitcoinold-0.5.4/
...
http://gitorious.org/bitcoinold/bitcoinoldd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Bitcoinold-Qt notifications under Growl 1.3.
Increase required age of Bitcoinold-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxBitcoinold properly when installing Bitcoinold-Qt over it. (Windows)
