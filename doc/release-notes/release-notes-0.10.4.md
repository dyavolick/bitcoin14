Bitcoinold Core version 0.10.4 is now available from:

  <https://bitcoinold.org/bin/bitcoinold-core-0.10.4/>
...
- #6953 `43c2789` Split bitcoinold-tx into its own package
- #6953 `dfe0d4d` Include bitcoinold-tx binary on Debian/Ubuntu
