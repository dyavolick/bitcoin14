Download URL: https://sourceforge.net/projects/bitcoinold/files/Bitcoinold/bitcoinold-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 BOL fee schedule (users still pay 0.01 BOL per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #bitcoinold00 - #bitcoinold99
