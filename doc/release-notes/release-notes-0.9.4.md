Bitcoinold Core version 0.9.4 is now available from:

  https://bitcoinold.org/bin/0.9.4/
...
this update is incompatible with the Bitcoinold system and could lead to consensus
forks.

Bitcoinold Core released binaries from https://bitcoinold.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~bitcoinold/+archive/ubuntu/bitcoinold
- A third-party or self-compiled Bitcoinold Core

upgrade to Bitcoinold Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
