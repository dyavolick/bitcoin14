Bitcoinold-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/bitcoinold/files/Bitcoinold/bitcoinold-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Bitcoinold
...
New/changed settings (command-line or bitcoinold.conf file)
--------------------------------------------------------
