Bitcoinold Core version 0.13.2 is now available from:

  <https://bitcoinold.org/bin/bitcoinold-core-0.13.2/>
...
- #8908 `4a974b2` Update bitcoinold-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow bitcoinold-tx to create v2 transactions (boldrak)
