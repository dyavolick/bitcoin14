Bitcoinold Core version 0.9.2.1 is now available from:

  https://bitcoinold.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 BOL to 0.01 BOL
...
- Fix "Start bitcoinold on system login"
