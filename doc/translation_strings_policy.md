...
This document provides guidelines for internationalization of the Bitcoinold Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `bitcoinold_en.ts` remains unchanged.
