...
import RPC call and node 0 sends BOL to it. Then other nodes import the
...
In the second part of the test, node 0 sends more BOL to each address, and the
...
class ImportRescanTest(BitcoinoldTestFramework):
    def __init__(self):
        super().__init__()
