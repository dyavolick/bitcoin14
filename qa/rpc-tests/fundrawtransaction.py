...
class RawTransactionsTest(BitcoinoldTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid bitcoinold address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid bitcoinold address" in e.error['message'])
