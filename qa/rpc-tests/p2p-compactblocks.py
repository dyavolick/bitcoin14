...
# TestNode: A peer we use to send messages to bitcoinoldd, and store responses.
...
class CompactBlocksTest(BitcoinoldTestFramework):
    def __init__(self):
        super().__init__()
    ...
    # This test actually causes bitcoinoldd to (reasonably!) disconnect us, so do this last.
    ...
    # Test that bitcoinoldd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for bitcoinoldd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # bitcoinoldd will not send blocktxn responses for blocks whose height is
