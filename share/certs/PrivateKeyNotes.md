...
unlocked to sign the Bitcoinold-Qt.app bundle.
...
allowing somebody to distribute a Bitcoinold-Qt.app or bitcoinold-qt-setup.exe with a valid
...
that the bitcoinold-qt.exe file inside the installer had not been tampered with.
